...
// Налаштування пінів для плати
#define BLINK_GPIO 48      // Вбудований RGB світлодіод 
...
/**
 * @brief Функція імітації виводу цифр у консоль 
 */
...
static void configure_peripherals(void)
{
    ...
    // 1. Налаштування вбудованого адресного світлодіода (LED Strip)
...
void app_main(void)
{
    ...
    while (1) {
        ...
        if (gpio_get_level(BUTTON_GPIO) == 0) {
            // Вивід номера варіанта при натисканні 
            ESP_LOGW(TAG, "КНОПКА НАТИСНУТА! номер у списку:");
            display_number_in_console(4); 
            
            // Червоний колір для візуального підтвердження натискання
